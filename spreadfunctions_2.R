...
library(igraph)
do_spr<-function(net,type=c("both","infected","informed"),n_seeds=1,loc_seeds=c("R","CL"),s,u,tmax,thresh=NA,infect.limit=NA,inform.limit=NA,inform.type=c("proportional","conformist"),min_learn=0.01,thr_steep=10,weighted=F,recovery=F,recoverytime=1,recoverprob=1,death=F,deathtime=1,deathprob=0.5,immune=F,immunetime=1,immuneprob=0.5,immuneendprob=0.5,returnnets=T,verbose=T){
  N=length(V(net))
